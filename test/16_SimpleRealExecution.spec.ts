...
describe("Zodiac Roles Module Simple Real Execution", function () {
    ...
    describe("Real Zodiac Roles Module Deployment", function () {
        it("should deploy and configure the Roles module", async function () {
            console.log("🚀 === REAL ZODIAC ROLES MODULE DEPLOYMENT ===");

            // Step 1: Deploy module proxy
            ...
            const setUpSelector = ethers.utils.id("setUp(bytes)").slice(0, 10);
            const initData = setUpSelector + initParams.slice(2);
