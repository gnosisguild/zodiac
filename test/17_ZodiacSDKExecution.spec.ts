...
describe("Zodiac Roles Module SDK Execution", function () {
    let safeOwner: any;
    ...
    describe("Zodiac SDK Module Deployment", function () {
        it("should deploy and configure the Roles module using Zodiac SDK", async function () {
            console.log("🚀 === ZODIAC SDK MODULE DEPLOYMENT ===");

            // Step 1: Deploy module proxy using Zodiac SDK pattern
            ...
            // Create initialization data using Zodiac SDK pattern
            // The Roles module expects: setUp(bytes calldata initParams)
            // Where initParams is: (address owner, address avatar, address target)
            const initParams = ethers.utils.defaultAbiCoder.encode(
                ["address", "address", "address"],
                [safeOwner.address, safeAddress, safeAddress]
            );

            // Create the setUp function call
